/**
 * Arjun Portal Theme — Client-side Enhancements
 * Matches the desk's KI-Admin design language on all portal/web pages.
 */
(function () {
    "use strict";

    // Never touch the login page — it keeps olscpl_hrms's own split-login design.
    ...
    const ArjunPortal = {
        ...
        addBodyClass: function () {
            document.body.classList.add('arjun-portal-active');
        },
